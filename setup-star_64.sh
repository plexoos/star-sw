...
source /afs/rhic/star/packages/ROOT/5.34.38/.sl73_x8664_gcc485/root/bin/thisroot.sh 
...
#export SITE=generic
export OPTSTAR=/afs/rhic/opt/star/sl73_x8664_gcc485/

export STAR_CVS_REF=YYY

#export STARCMPL=gcc
#export STARCMPLC=gcc

#export STAR_HOST_SYS=sl73_x8664_gcc485
